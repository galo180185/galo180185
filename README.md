...
### UX/UI Designer en Formación | Ex-Recursos Humanos 👥 ➔ 🎨

¡Bienvenido a mi perfil! Estoy haciendo la transición del mundo de la Gestión del Talento Humano hacia el Diseño UX/UI. Mi experiencia en Recursos Humanos me dio una base sólida en **empatía profunda**, **psicología del usuario** e **investigación**, habilidades que ahora aplico para diseñar experiencias digitales intuitivas, accesibles y centradas en las personas.

Actualmente me formo intensamente en el bootcamp de **TripleTen**.

---

## 🚀 Sobre mí

- 🎓 Estudiante de **Diseño UX/UI** en [TripleTen](https://tripleten.com).
- 💼 **Experiencia previa:** + 10 años en Recursos Humanos (Procesos inernos, Reclutamiento, Cultura y Clima Organizacional).
- 🌱 Aprendiendo de forma activa: **Figma, FigJam, Miro, Maze**.
- 🔍 Buscando oportunidades de práctica o proyectos colaborativos donde pueda aportar valor con mi visión humana.
...
`• Figma • Prototipado Avanzado • Wireframing • Design Systems`

### Investigación y Metodologías (UX Research)
`• Entrevistas de Usuario • Personas • User Journeys • Pruebas de Usabilidad • Design Thinking • Heuristic Evaluation`

### Habilidades Transferibles (De mi experiencia en RRHH)
`• Empatía Activa • Comunicación Estratégica • Gestión de Stakeholders • Resolución de Problemas • Trabajo en Equipo`

---

## 🎨 Mis Proyectos Destacados (UX/UI Case Studies)
